...
Postscript 103 refuted "rulings are constant-count lines": of eight distinct
...
vanish simultaneously (the corner-to-corner contact of Postscript 96). Every
...
Postscript 104 removes the only arithmetic obstacle: **det(Q) is a perfect square
...
* and, where it is a rational root of the line, **the arc's own terminus**
  (arc A's is `s = 19/6`, m = 3 by Postscript 96 — it must come out that way, and
...
component — the scale-matched window of Postscript 103, NOT the spec-2026-08-11
...
4. **What is m at the known arc termini** across all four lines? Postscript 96
...
path, which is worth as much as opening one — Postscript 105's exchange-rate note
