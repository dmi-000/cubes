> **Work order** for the depth-explorer viewer, written by a delegated agent and
> left under its machine-generated name until 2026-08-11. Renamed from
> `rosy-puzzling-hanrahan-agent-afd595c7d34e6b7c1.md`; see `VIEWERS.md` for the
