#!/usr/bin/env python3
# Working principles: specs/SYMMETRY_SEARCH_SPEC.md. Project index: README.md
...
Setup (specs/SYMMETRY_SEARCH_SPEC.md section 1): a cube ORIENTATION is a coset
...
def phase3_note():
    ...
    return {
        ...
        'towers': 'mixed-axis composita -- specs/QFIELD_SPEC.md already found the '
...
def write_report(path, gate_results, p1, p2, p3):
    ...
    lines.append('Working principles: specs/SYMMETRY_SEARCH_SPEC.md. Generated by '
                  'symmetry_search.py.\n')
    lines.append('## Gates\n')
