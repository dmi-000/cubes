#!/usr/bin/env python3
# Working principles: this file's own docstring + PROJECT.md + LEDGER.md
...
of LEDGER.md) identifies as the ingredients of every
record.
...
files (LEDGER.md, exact_search_results.jsonl) -- this
...
def write_report(gates, dt):
    ...
    L.append('Working principles: this file\'s own docstring; PROJECT.md; '
             'LEDGER.md Postscripts 12/16/17/17-addendum. '
