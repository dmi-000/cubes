#!/usr/bin/env python3
# Working principles: specs/BLUEPRINT_SPEC.md; blueprint_enum.py (catalog source);
...
# LEDGER.md Postscripts 12/17/17-addendum/18/19; PROJECT.md.
...
reduction -- the report states it explicitly per specs/BLUEPRINT_SPEC.md's
...
def write_report(catalog, gate_info, t_start, done_so_far, beats, in_progress=True):
    ...
    L.append('Working principles: specs/BLUEPRINT_SPEC.md; blueprint_enum.py (catalog); '
             'shared_axis_search.py (reused cluster/spoke/climb machinery); '
             'LEDGER.md Postscripts 12/17/17-addendum/18/19; '
