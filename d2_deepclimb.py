#!/usr/bin/env python3
# Working principles: specs/D2_DEEPCLIMB_SPEC.md. Project index: README.md
"""D2:4+free2 deep-climb + D2-sibling sweep + shallow-tail (d3-vs-total)
tradeoff mapping. Spec: specs/D2_DEEPCLIMB_SPEC.md.
...
# The two known 717 seeds (specs/D2_DEEPCLIMB_SPEC.md + symmetry_search2.jsonl).
KNOWN_717 = {
...
def write_report(gate_ok, t1, t2, table, n_scanned):
    ...
    L.append('Working principles: specs/D2_DEEPCLIMB_SPEC.md. Generated by '
